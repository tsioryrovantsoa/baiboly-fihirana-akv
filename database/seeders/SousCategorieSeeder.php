...
class SousCategorieSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $souscategories = [
            ...
            ['categorie_id' => 3, 'nom' => "Sampana VokovokoManga", 'acronyme' => 'SVM', 'afficher_acronyme' => false, 'numero_requis' => false, 'logo' => 'svm.jpg'],
            ['categorie_id' => 3, 'nom' => "Sampana Tanora Kristiana", 'acronyme' => 'STK', 'afficher_acronyme' => false, 'numero_requis' => false, 'logo' => 'stk.jpg'],
            ['categorie_id' => 3, 'nom' => "Sampana Vondrona Fototra Laika", 'acronyme' => 'VFL', 'afficher_acronyme' => false, 'numero_requis' => false, 'logo' => 'vfl.jpg'],
            ['categorie_id' => 3, 'nom' => "Sampanasa Asa Fitoriana Filazantsara", 'acronyme' => "AFF", 'afficher_acronyme' => false, 'numero_requis' => false, 'logo' => 'aff.jpg'],
