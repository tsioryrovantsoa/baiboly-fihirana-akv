...
class SousCategorieSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $souscategories = [
            ...
            ['categorie_id' => 3, 'nom' => "FIkambanan'ny MPItendry Zavamaneno", 'acronyme' => 'FIMPIZ', 'afficher_acronyme' => false, 'numero_requis' => false],
            ...
            ['categorie_id' => 3, 'nom' => "Sampana Lehilahy Kristiana", 'acronyme' => 'SLK', 'afficher_acronyme' => false, 'numero_requis' => false],
            ['categorie_id' => 3, 'nom' => "Sampana VokovokoManga", 'acronyme' => 'SVM', 'afficher_acronyme' => false, 'numero_requis' => false],
            ['categorie_id' => 3, 'nom' => "Sampana Tanora Kristiana", 'acronyme' => 'STK', 'afficher_acronyme' => false, 'numero_requis' => false],
            ['categorie_id' => 3, 'nom' => "Sampana Vondrona Fototra Laika", 'acronyme' => 'VFL', 'afficher_acronyme' => false, 'numero_requis' => false],
            ['categorie_id' => 3, 'nom' => "Sampanasa Asa Fitoriana Filazantsara", 'acronyme' => "AFF", 'afficher_acronyme' => false, 'numero_requis' => false],
            ['categorie_id' => 3, 'nom' => "SAmpana FIFohazana", 'acronyme' => "SAFIF", 'afficher_acronyme' => false, 'numero_requis' => false],
            ['categorie_id' => 3, 'nom' => "SAmpana MPAnazava sy TIly", 'acronyme' => "SAMPATI", 'afficher_acronyme' => false, 'numero_requis' => false],
